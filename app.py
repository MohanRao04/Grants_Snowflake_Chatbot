...
if not st.session_state.authenticated:
    ...
    for idx, message in enumerate(st.session_state.chat_history):
        ...
        if idx == 0 and message["content"] == "Hi, I am your Grants Assistant. I can help you explore data, insights and analytics on PBCS (Planning and Budgeting insight solution).":
            continue
